...
{
    public class CheckPoint :IDeletable, ISpatial, IHandleable
	{
		...
		PoolHandle IHandleable.Handle => Handle;
		...
		private void CreateCheckpoint()
		{
			...
			try
			{
				uint _handle = NativeFunction.Natives.CREATE_CHECKPOINT<uint>((int)Type, pos.X, pos.Y, pos.Z, NextPosition.X, NextPosition.Y, NextPosition.Z, Radius, Color.R, Color.G, Color.B, Color.A, 0);
				Handle = _handle;
				IsValid = true;
